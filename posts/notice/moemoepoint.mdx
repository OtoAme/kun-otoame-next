...
description: 'TouchGal 的萌萌点用于限制与激励社区行为：萌萌点超过 20 才能发布 Galgame 资源，更改用户名需消耗 30 点。萌萌点可通过每日签到随机获得 2–7 点（呈正态分布），也可在发布 Galgame、发布资源或补丁时获得固定奖励，删除资源会同步扣除相应点数。内容被点赞也会带来 1 点增益，取消则扣回。通过多样互动与贡献，用户可持续积累萌萌点并提升社区参与度。'
date: 2026-02-19
authorUid: 1
