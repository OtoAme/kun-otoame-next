...
export const NSFWMask = ({
  ...
  return (
    <div
      className={`absolute inset-0 z-10 flex flex-col items-center justify-center bg-black/60 backdrop-blur-md rounded-lg transition-all duration-300 group-hover:bg-black/40 ${
